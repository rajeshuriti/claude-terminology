export interface ExamSubdomain {
  id: string;
  title: string;
  knowledge: string[];
  skills: string[];
...
export const examInfo = {
  ...
  questionFormat: 'Multiple choice, one correct answer',
  scenariosPerExam: 4,
  totalScenarios: 6,
  version: '0.1',
  updated: 'Feb 10 2025',
...
export const examScenarios = [
  { id: 'S1', title: 'Customer Support Resolution Agent', domains: ['D1', 'D2', 'D5'] },
  { id: 'S2', title: 'Code Generation with Claude Code', domains: ['D3', 'D5'] },
  { id: 'S3', title: 'Multi-Agent Research System', domains: ['D1', 'D2', 'D5'] },
  { id: 'S4', title: 'Developer Productivity with Claude', domains: ['D2', 'D3', 'D1'] },
  { id: 'S5', title: 'Claude Code for Continuous Integration', domains: ['D3', 'D4'] },
  { id: 'S6', title: 'Structured Data Extraction', domains: ['D4', 'D5'] },
];

export const examDomains: ExamDomain[] = [
  {
    id: 'D1', number: '1', weight: 27,
    title: 'Agentic Architecture & Orchestration',
    color: '#8b5cf6', bg: 'bg-violet-500', emoji: '🤖',
    subdomains: [
      {
  ...
  {
    id: 'D2', number: '2', weight: 18,
    title: 'Tool Design & MCP Integration',
    color: '#0ea5e9', bg: 'bg-sky-500', emoji: '🔧',
    subdomains: [
      {
  ...
  {
    id: 'D3', number: '3', weight: 20,
    title: 'Claude Code Configuration & Workflows',
    color: '#10b981', bg: 'bg-emerald-500', emoji: '⚙️',
    subdomains: [
      {
  ...
  {
    id: 'D4', number: '4', weight: 20,
    title: 'Prompt Engineering & Structured Output',
    color: '#f59e0b', bg: 'bg-amber-500', emoji: '✍️',
    subdomains: [
      {
  ...
  {
    id: 'D5', number: '5', weight: 15,
    title: 'Context Management & Reliability',
    color: '#f43f5e', bg: 'bg-rose-500', emoji: '🛡️',
    subdomains: [
      {
